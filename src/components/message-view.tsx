                ...
                <div className="flex flex-col gap-2 px-3 py-2 bg-[#1a1a2e] rounded-lg border border-[#2a2a4a]">
                  ...
                  {workflowExecution.status === 'handoff' ? (
                    <button
                      ...
                      className="text-[11px] font-semibold text-emerald-400 bg-emerald-400/10 hover:bg-emerald-400/20 px-3 py-1.5 rounded-full transition-colors whitespace-nowrap flex items-center justify-center gap-1 disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      disabled={workflowActionLoading}
                      className="text-[11px] font-semibold text-amber-400 bg-amber-400/10 hover:bg-amber-400/20 px-3 py-1.5 rounded-full transition-colors whitespace-nowrap flex items-center justify-center gap-1 disabled:opacity-50"
                    >
