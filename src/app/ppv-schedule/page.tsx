    ...
    <div className="min-h-screen bg-[var(--wa-bg)] transition-colors duration-200">
          ...
          <div className="flex items-center justify-between h-14">
            ...
            <div className="flex items-center gap-1">
              ...
              <button onClick={() => { resetForm(); setShowForm(true); }}
                className="flex items-center gap-1.5 px-3 sm:px-3.5 py-2 text-[13px] font-semibold rounded-xl bg-[var(--wa-green)] text-white hover:opacity-90 active:scale-[0.97] transition-all shadow-sm">
          ...
          <div className="flex -mb-px">
            {([
              ...
              <button key={f.key} onClick={() => { setFilterTime(f.key); setVisibleCount(20); }}
                ...
                {f.label}
                <span className={cn(
                  "ml-1 sm:ml-1.5 inline-flex items-center justify-center min-w-[18px] sm:min-w-[20px] h-5 px-1 sm:px-1.5 rounded-full text-[10px] sm:text-[11px] font-semibold",
            ...
            {grouped.map(({ date, pics }) => {
              ...
              <section key={date}>
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <span className="inline-flex items-center gap-2 px-2.5 sm:px-3 py-1 rounded-full text-[11px] sm:text-[12px] font-semibold text-indigo-600 dark:text-indigo-400 bg-indigo-500/8 dark:bg-indigo-500/10 whitespace-nowrap">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="px-3 sm:px-4 py-3 sm:py-3.5">
                                <div className="flex items-start justify-between gap-2">
                                  <h3 className="text-[13px] sm:text-[14px] font-semibold text-[var(--wa-text-primary)] leading-snug">{s.matchDetails}</h3>
                                ...
                                <div className="flex items-center gap-2 sm:gap-3 mt-2.5 sm:mt-3 flex-wrap text-[11px] sm:text-[12px] text-[var(--wa-text-secondary)]">
                              ...
                              <div className="flex items-center border-t border-[var(--wa-border)] divide-x divide-[var(--wa-border)]">
                                {s.status !== 'completed' && s.status !== 'cancelled' && (
                                  <button onClick={() => handleMarkComplete(s)}
                                    className="flex-1 flex items-center justify-center gap-1.5 py-2.5 sm:py-2 text-[12px] font-medium text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/5 transition-colors">
                                    <Check className="h-3.5 w-3.5" /> Complete
                                  </button>
                                )}
                                <button onClick={() => openEdit(s)}
                                  className="flex-1 flex items-center justify-center gap-1.5 py-2.5 sm:py-2 text-[12px] font-medium text-[var(--wa-text-secondary)] hover:bg-[var(--wa-hover)] transition-colors">
                                  <Pencil className="h-3.5 w-3.5" /> Edit
                                </button>
                                <button onClick={() => handleDelete(s.id)}
                                  className="flex-1 flex items-center justify-center gap-1.5 py-2.5 sm:py-2 text-[12px] font-medium text-red-500 dark:text-red-400 hover:bg-red-500/5 transition-colors">
      ...
      {showForm && (
        <>
          ...
          <div className="fixed top-0 right-0 bottom-0 w-full sm:max-w-[420px] z-50 bg-[var(--wa-panel-bg)] border-l border-[var(--wa-border)] shadow-2xl flex flex-col animate-[slideIn_0.25s_ease-out]">
            {/* Slideover header */}
